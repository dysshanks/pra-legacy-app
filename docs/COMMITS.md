...
## added project
- **Commit:** `d2f5deb1fac0bba0bc2389e383208bc4f88285c2`
- **Date:** 2025-09-08 09:41:31 +0200
- **Author:** dysshanks
...
Date:   Mon Sep 8 09:41:31 2025 +0200
```
...
+/.idea
+/.vscode
diff --git a/4s_manuals.sql b/4s_manuals.sql
new file mode 100644
index 0000000..40d201d
--- /dev/null
+++ b/4s_manuals.sql
@@ -0,0 +1,188 @@
+-- phpMyAdmin SQL Dump
...
+    } */
+}
diff --git a/app/Http/Controllers/ManualController.php b/app/Http/Controllers/ManualController.php
new file mode 100644
index 0000000..4194c69
--- /dev/null
+++ b/app/Http/Controllers/ManualController.php
@@ -0,0 +1,21 @@
+<?php
+
+namespace App\Http\Controllers;
...
+    }
+}
diff --git a/app/Http/Controllers/RedirectController.php b/app/Http/Controllers/RedirectController.php
new file mode 100644
index 0000000..1988642
--- /dev/null
...
+    }
+};
diff --git a/database/migrations/2023_09_07_081733_create_brands_table.php b/database/migrations/2023_09_07_081733_create_brands_table.php
new file mode 100644
index 0000000..2314a95
--- /dev/null
+++ b/database/migrations/2023_09_07_081733_create_brands_table.php
@@ -0,0 +1,28 @@
+<?php
+
+use Illuminate\Database\Migrations\Migration;
...
+    }
+};
diff --git a/database/migrations/2023_09_07_081753_create_manuals_table.php b/database/migrations/2023_09_07_081753_create_manuals_table.php
new file mode 100644
index 0000000..0a59526
--- /dev/null
+++ b/database/migrations/2023_09_07_081753_create_manuals_table.php
@@ -0,0 +1,35 @@
+<?php
+
+use Illuminate\Database\Migrations\Migration;
...
diff --git a/public/img/afbI_logo.png b/public/img/afbI_logo.png
new file mode 100644
index 0000000..1db409e
Binary files /dev/null and b/public/img/afbI_logo.png differ
...
+
+];
diff --git a/resources/lang/en/introduction_texts.php b/resources/lang/en/introduction_texts.php
new file mode 100644
index 0000000..bf08934
--- /dev/null
+++ b/resources/lang/en/introduction_texts.php
@@ -0,0 +1,22 @@
+<?php
+
+return [
...
+    */
+
+    'ads_not_displayed' => "Test environment; adds not displayed",
+    'page_not_found' => "The page you tried to open does not exist.",
+
+];
diff --git a/resources/lang/en/misc.php b/resources/lang/en/misc.php
new file mode 100644
index 0000000..c000402
--- /dev/null
+++ b/resources/lang/en/misc.php
@@ -0,0 +1,26 @@
+<?php
+
+return [
...
+
+];
diff --git a/resources/lang/nl/introduction_texts.php b/resources/lang/nl/introduction_texts.php
new file mode 100644
index 0000000..e1ed4a4
--- /dev/null
+++ b/resources/lang/nl/introduction_texts.php
@@ -0,0 +1,21 @@
+<?php
+
+return [
...
+    'page_not_found' => "De pagina die u probeerde te openen kon niet worden gevonden.",
+
+];
diff --git a/resources/lang/nl/misc.php b/resources/lang/nl/misc.php
new file mode 100644
index 0000000..fc32111
--- /dev/null
+++ b/resources/lang/nl/misc.php
@@ -0,0 +1,26 @@
+<?php
+
+return [
...
+    </div>
+</nav>
diff --git a/resources/views/components/search_results.blade.php b/resources/views/components/search_results.blade.php
new file mode 100644
index 0000000..fdaec77
--- /dev/null
+++ b/resources/views/components/search_results.blade.php
@@ -0,0 +1,12 @@
+<script>
+  (function() {
+	var cx = 'partner-pub-6236044096491918:8149652050';
...
+
+</x-layouts.app>
diff --git a/resources/views/pages/manual_view.blade.php b/resources/views/pages/manual_view.blade.php
new file mode 100644
index 0000000..f4731a7
--- /dev/null
+++ b/resources/views/pages/manual_view.blade.php
@@ -0,0 +1,24 @@
+<x-layouts.app>
+
+    <x-slot:head>
...
+)
diff --git a/resources/views/pages/status_404.blade.php b/resources/views/pages/status_404.blade.php
new file mode 100644
index 0000000..b9c5539
--- /dev/null
+++ b/resources/views/pages/status_404.blade.php
@@ -0,0 +1,5 @@
+<x-layouts.app>
+
...
+schedule-*
+services.json
diff --git a/storage/framework/.gitkeep b/storage/framework/.gitkeep
new file mode 100644
index 0000000..e69de29
